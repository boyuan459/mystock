...
.controller('ChatroomCtrl', ['$scope', '$rootScope', '$stateParams', '$firebaseArray', '$ionicScrollDelegate', 'firebaseRef', 'userService', function($scope, $rootScope, $stateParams, $firebaseArray, $ionicScrollDelegate, firebaseRef, userService) {
